...
import copy
import sys
sys.path.append('/home/honsen/tartan/TFNet-main/testMod')
# from testMod.defCorr import Get_DefCorrelation
from testMod.multiDelCorr import MS_DefCorrelation_Module
model_urls = {
...
class Get_Correlation(nn.Module):
    ...
    def forward(self, x):
        ...
        # N, T, H, W, H1, W1 = affinities.shape
        # MC1 = affinities.view(T, H * W, H1 * W1)
...
class ResNetCorr(nn.Module):
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.layer2 = self._make_layer(block, 128, layers[1], stride=2)
        self.corr1 = MS_DefCorrelation_Module(self.inplanes)
        self.layer3 = self._make_layer(block, 256, layers[2], stride=2)
